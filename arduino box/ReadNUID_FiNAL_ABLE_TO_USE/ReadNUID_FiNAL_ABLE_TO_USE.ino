...
if((flag == true) || (oldflag==true)){
  ...
  if (piccType != MFRC522::PICC_TYPE_MIFARE_MINI &&  
    ...
    JSON["First Byte"]=rfid.uid.uidByte[0];
     JSON["Second Byte"]= rfid.uid.uidByte[1];
      JSON["Third Byte"]= rfid.uid.uidByte[2];
       JSON["Fourth Byte"]= rfid.uid.uidByte[3];
...
//  Serial.println("No Card");
  JSON["status"] = false;
    ...
    JSON["First Byte"]= 0xFF;
     JSON["Second Byte"]= 0xFF;
      JSON["Third Byte"]= 0xFF;
       JSON["Fourth Byte"]= 0xFF;
   serializeJsonPretty(JSON, Serial);
